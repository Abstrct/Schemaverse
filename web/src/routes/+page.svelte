...
<svelte:head><title>Schemaverse</title></svelte:head>
...
<div class="front">
	...
	<main>
		<section class="hero">
			<img class="mark" src="/brand/wordmark-light.svg" alt="Schemaverse" />
			...
			<p class="mono muted psql">psql -h {typeof location !== 'undefined' ? location.hostname : 'localhost'} -U &lt;you&gt; schemaverse</p>
		</section>

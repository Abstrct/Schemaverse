...
-- requires: function-round_control@v1.2
--
-- Rework: a fresh round_seq returns 1 from its first nextval(), so the first
-- rollover stays in round 1. Players registered before that already have a
-- round-1 stats row; inserting it again violated the primary key.

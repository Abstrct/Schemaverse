...
-- requires: function-round_control@v1.1
-- requires: event-partitioned
--
-- Rework: events survive the round. A partition for the new round is created
-- after round_seq advances, and the old partition becomes history.

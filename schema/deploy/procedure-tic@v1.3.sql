...
-- requires: procedure-tic@v1.1
-- requires: function-ensure_event_partition
--
-- Rework: tic_open() makes sure the current round's event partition exists
-- (see ensure_event_partition).

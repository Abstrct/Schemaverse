...
-- requires: trigger-player_creation@v1.0
-- requires: function-register_player
...
DECLARE 
	new_planet RECORD;
BEGIN
	-- Role creation moved to register_player(). This trigger only hands out a
	-- home planet and the stats rows.
